...
public protocol SwipingCarouselTwoDelegate : class {
    func cellSwipedUp(_ cell: UICollectionViewCell)
    func cellSwipedDown(_ cell: UICollectionViewCell)
}

open class SwipingCarouselCollectionViewTwoCell: UICollectionViewCell {
    
    public weak var delegate: SwipingCarouselTwoDelegate?
